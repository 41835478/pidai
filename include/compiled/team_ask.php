...
<div id="consult">
	<div class="dashboard" id="dashboard">
		<ul><?php echo current_ask('ask', $id); ?></ul>
	</div>
	<div id="content">
		<div class="box">
			...
			<div class="box-content">
				...
				<?php if(is_login()){?>
					...
					<div id="consult-add-succ" class="succ"><p>您的问题已成功提交，客服MM很快就会回复的，稍等一会儿再来看吧。</p><p><a href="/team.php?id=<?php echo $team['id']; ?>">返回本团购</a>，或<a id="consult-add-more" href="javascript:void(0);">还有其他问题？</a></p></div>
				<?php } else { ?>
