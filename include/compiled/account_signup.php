      ...
      <div id="content" class="signup-box">
        <div class="box">
          <div class="box-content">
            <div class="head2">
              <h3><img src="/static/theme/xiutuan/css/images/tit_reg.png"  />&nbsp;&nbsp;<span class="span_normal">或者<a href="/account/login.php" class="linkO1">登录</a></span></h3>
            </div>
            <div class="sect">
					...
					<?php }?>
                        ...
                        <div class="act">
                            <input type="image" value="注册" name="commit" id="signup-submit" src="/static/theme/xiutuan/css/images/but_reg.gif"/>
                        </div>
                    </form>
                </div>
          </div>
        ...
        <div class="sbox">
          <div class="sbox-content">
            <div class="side-tip">
              ...
              <p>请直接<a href="/account/login.php" class="linkO1">登录</a>。</p>
                  <h2>用微博账号登录<?php echo $INI['system']['abbreviation']; ?>！</h2>
                    <p><a href="/thirdpart/sina/login.php" target="_blank"><img src="/static/css/i/sina_button.png" width="126" height="24" /></a></p>
                    <p><a href="/thirdpart/qq/index.php " target="_blank"><img src="/static/css/i/qq_button.png" alt="" width="126" height="24" /></a></p>
            </div>
